    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500">
            Welcome back. Managing <span className="font-semibold text-blue-600">{admin.school?.name || "School System"}</span>
          </p>
        </div>
        <div className="flex gap-3">
          <span className="bg-purple-100 text-purple-800 px-4 py-2 rounded-full text-sm font-bold shadow-sm">
            Admin Access
          </span>
          <span className="bg-gray-100 text-gray-600 px-4 py-2 rounded-full text-sm font-medium shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-between h-32 relative overflow-hidden">
          ...
          <div className="text-xs text-blue-600 font-medium">Active Profiles</div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-between h-32">
          ...
          <div className="text-xs text-green-600 font-medium">Extracurriculars</div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-between h-32">
          ...
          <div className="text-xs text-orange-600 font-medium">Athletic Programs</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            <button className="w-full text-left px-4 py-3 bg-gray-50 hover:bg-blue-50 border rounded-lg transition-colors flex justify-between group">
              <span className="font-medium text-gray-700 group-hover:text-blue-700">Manage Course Catalog</span>
              <span className="text-gray-400">→</span>
            </button>
            <button className="w-full text-left px-4 py-3 bg-gray-50 hover:bg-blue-50 border rounded-lg transition-colors flex justify-between group">
              <span className="font-medium text-gray-700 group-hover:text-blue-700">View Student IGPs</span>
              <span className="text-gray-400">→</span>
            </button>
            <button className="w-full text-left px-4 py-3 bg-gray-50 hover:bg-blue-50 border rounded-lg transition-colors flex justify-between group">
              <span className="font-medium text-gray-700 group-hover:text-blue-700">Update School Settings</span>
              <span className="text-gray-400">→</span>
            </button>
          </div>
        </div>
